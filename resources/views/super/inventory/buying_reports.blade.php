...
@push('css')
    {{-- expr --}}
@endpush
@section('page-title','Buying Reports')
@section('content')
    <div class="col-md-6">
        <div class="tile">
            <div class="tile-body">
                <table class="table" style="border: none;" border="0">
                    <tbody>
                    <tr>
                        <td style="font-weight: bold;border: none;">Today Buy</td>
                        ...
                        <td style="font-weight: bold;border: none;">
                            @php
                                ...
                                foreach($todayInventories as $inventory){
                                    $totalCost += $inventory->buying_price;
                    ...
                    <tr>
                        <td style="font-weight: bold;border: none;">Weekly Buy</td>
                        <td style="font-weight: bold;border: none;">:</td>
                    ...
                    <tr>
                        <td style="font-weight: bold;border: none;">Monthly Buy</td>
                        <td style="font-weight: bold;border: none;">:</td>
    ...
    <div class="col-md-3">
        <div class="tile">
            <div class="tile-header">
                <h3>By Date Search</h3>
            </div>
            <div class="tile-body">
                <h4 class="text-center"></h4>
            <hr>
            <form action="{{ route('super.buying_single_date') }}" method="post" role="form">
                @csrf
        ...
        <div class="tile">
            <div class="tile-body">
                <div class="x_content">
                    ...
                    <hr>
                    <form action="{{ route('super.buying_date_wise') }}" method="POST" class="form-horizontal form-label-left">
                        @csrf
                ...
                <hr>
                <a href="{{ route('super.today_buying_report') }}"
                   class="btn btn-info btn-block">Today Report</a>
                <a href="{{ route('super.weekly_buying_report') }}"
                   class="btn btn-success btn-block">Weekly Report</a>
                <a href="{{ route('super.monthly_buying_report') }}"
