...
@section('page-title','Slider Image')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 style="float: left;">Create New Slider Image</h4>
                        <button type="button" class="close" data-dismiss="modal"
                                aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('super.slider.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control"
                                       id="store_name" placeholder="Slider Title"
                ...
                nowrap" style="width:100%">
                    ...
                    @foreach($sliders as $key=>$slider)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route("super.slider_product",$slider->id) }}" class="btn btn-info">
                                    @php
                                        $totalProduct = DB::table('sliderproducts')
                            ...
                            <td class="text-center">
                                <a class="btn btn-info" data-toggle="modal"
                                   href='#slider_edit{{ $slider->id }}'>
                                    <i class="fa fa-edit"></i></a>
                                <div class="modal fade" id="slider_edit{{ $slider->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4>Edit Slider&nbsp;&nbsp;-&nbsp;&nbsp;
                                            ...
                                            <div class="modal-body">
                <form action="{{ route('super.slider.update',$slider->id) }}"
                    ...
                    <button type="button"
                        ...
                        Close
                                ...
                                <form id="delete-form-{{ $slider->id }}"
                                      action="{{ route('super.slider.destroy',
                                      $slider->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
