...
@section('title','Today offer Management')
@push('css')

@endpush

@section('page-title','Today offer Management')
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('super.today_offer_search') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label></label>
                                        <button type="submit" class="btn btn-info btn-block">Search Product</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-md-2">
                <a href="{{ route('super.today_offer.create') }}" class="btn btn-primary btn-block">
                ...
                <table id="offer-table" class="table table-striped table-bordered nowrap" style="width:100%">
                    ...
                    @foreach($offers as $key=>$offer)
                        <tr>
                            ...
                            <td class="text-center">{{ $offer->offer_date }}</td>
                            <td class="text-center">
