                        ...
                        <span style="float: right;">
                            ...
                            <div class="selector" style="width: 190px;">
                                <select class="selectProductSort form-control" id="selectProductSort" onchange="top.location.href = this.options[this.selectedIndex].value">
                                    ...
                                    <option value="{{ route("sort_by_all", ['name'=>'products','sort'=>'low-to-high']) }}">
                                        Price: Low To High
                                    </option>
                                    <option value="{{ route("sort_by_all", ['name'=>'products','sort'=>'high-to-low']) }}">
                                        Price: High To Low
                                    </option>
                                </select>
                            </div>
                        </form>
                               Total {{ $products->count() }} Items In This Page
                            </span>
                    </div>
                </div>
            </div>
