                        ...
                        <span style="float: right;">
                            ...
                            <div class="selector" style="width: 190px;">
                                <select class="selectProductSort form-control" id="selectProductSort" onchange="top.location.href = this.options[this.selectedIndex].value">
                                    ...
                                    <option value="{{ route("sort_by_offer", ['name'=>$route,'slug'=>$basic->slug,'sort'=>'low-to-high']) }}">
                                        Price: Low To High
                                    </option>
                                    <option value="{{ route("sort_by_offer", ['name'=>$route,'slug'=>$basic->slug,'sort'=>'high-to-low']) }}">
                                        Price: High To Low
                                    </option>
                                </select>
                            </div>
                                ...
                                @if(isset($countProduct))
                                    Total {{ $countProduct->count() }} Items In This Page
                                {{--@else--}}
