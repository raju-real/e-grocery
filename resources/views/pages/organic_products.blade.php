<div class="featured_area">
    <div class="container">
            ...
            <div class="col-xs-12">
                <div class="section_title">
                    <h3>
                        ...
                        </span>Organic Product
                    </h3>
                </div>
            </div>
        </div>
        @php
        $products = DB::table('products')->where('category_id',2)->latest()->paginate(15);
        @endphp
        <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="single_product">
                            ...
                            <div class="product_content">
                                ...
                                <div class="price_box">
                                    @if($product->discount_price != null)
                                        <span class="old-price" style="font-size: 15px;color: black;line-height: 17px;">
                                            {{ $product->unit_price }}
                                    ...
                                    @else
                                        <i class="fb-taka"></i>
                                        <span style="font-size: 15px;color: #f57224;line-height: 17px;">
        ...
        <span style="float: right;">
            <a href="{{ route('category',"Organic-Food") }}" class="btn btn-default btn-lg"
