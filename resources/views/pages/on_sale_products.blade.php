@php
    $products = DB::table('products')->where('category_id',9)
    ->where('sku','In Stok')
    ->latest()->paginate(15);
@endphp
                        ...
                        <div class="single_product">
                            <div class="product_image">
                                ...
                                <a class="product_img_link"
                                   href="{{ route('product_details',['slug'=>$product->slug,'price'=>Crypt::encrypt($price) ]) }}">
                            ...
                            <div class="product_content">
                                <a href="{{ route('product_details',['slug'=>$product->slug,'price'=>Crypt::encrypt($price) ]) }}"
                                   class="product-name" style="height: 50px;">
                                ...
                                <div class="price_box">
                                    @if($product->discount_price != null)
                                        <span class="old-price" style="font-size: 14px;color: #3c3c3c;line-height: 17px;">
                                            {{ $product->unit_price }}
                                        </span>
