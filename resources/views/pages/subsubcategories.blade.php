            ...
            <div class="row">
                    <div class="col-xs-12">
                        <div class="breadcrumb" style="font-weight: bold;font-size: 18px;">
                            ...
                            <span style="float: right;">Total {{ $subsubcategories->count() }} Items</span>
                        </div>
                    </div>
                </div>
            <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="single_product">
                                                    <div class="product_image">
                                                        <a class="product_img_link" href="{{ route('subsubcategory_wise_product',$subcategory->slug) }}">
                                                            @if($subcategory->image != null)
                                                                <img src="{{ asset('images/subsubcategory/'.$subcategory->image) }}" alt="">
                                                            @else
                                                    ...
                                                    <div class="product_content">
                                                        <a href="{{ route('subsubcategory_wise_product',$subcategory->slug) }}" class="product-name" style="height: 50px;margin-left: 20px;">
                                                            {{ $subcategory->name }}
                                                        </a>
                                                    </div>
                                                </div>
