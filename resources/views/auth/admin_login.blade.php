...
<html>
  ...
  <body>
    <section class="material-half-bg" >
      <div class="cover" style="background-image: url('{{ asset('assets/images/loginpage_bg.jpg') }}');"></div>
    </section>
      ...
      <div class="login-box" style="height: auto;">
        <form class="login-form" action="{{ route('admin-login') }}" method="POST" onsubmit="return validate()">
          ...
          <div class="form-group">
            ...
            <input name="mobile" class="form-control" type="text" id="email" placeholder="Mobile" onkeypress="hideEmailError()">
